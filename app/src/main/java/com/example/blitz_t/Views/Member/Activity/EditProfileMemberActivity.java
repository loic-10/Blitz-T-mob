...
public class EditProfileMemberActivity extends AppCompatActivity {
    ...
    private EditProfileMemberActivity mEditProfileMemberActivity;
    ...
    protected void onCreate ( Bundle savedInstanceState ) {
        ...
        mEditProfileMemberActivity = this;
                ...
                switch (v.getId()){
                    case R.id.text_birth_date_register_group :
                        ...
                        DatePickerDialog datePickerDialog = new DatePickerDialog(
                                EditProfileMemberActivity.this,
    ...
    private void updatedMember( final Member member, final int messageSuccess){
        ...
        Model.saveFromPreference(member, getString(R.string.SHARED_PREF_MEMBER_LOGIN), getString(R.string.PREFERENCE_FILE_KEY), mContextWrapper );
