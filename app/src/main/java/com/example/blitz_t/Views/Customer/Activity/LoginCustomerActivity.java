                ...
                for (DataSnapshot data : dataSnapshot.getChildren()) {
                    ...
                    if(customer != null &&
                        ...
                        customer.getPassword().equals(text_password_login.getText().toString())){
                            ...
                            Model.saveFromPreference(customer, getString(R.string.SHARED_PREF_CUSTOMER_LOGIN),
        ...
        sCustomerHelper.getCustomers().addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange ( @NonNull DataSnapshot dataSnapshot ) {
                ...
                if(microfinances.size() <= 0){
                    Intent intent = new Intent(getApplicationContext(), MembershipRequestCustomerActivity.class);
                    startActivity(intent);
                    finish();
                }
            }
